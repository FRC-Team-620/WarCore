...
public class SparkPIDDrivewrapper extends SparkMax {
	 ...
	 *
	 * @param deviceId
	 *            the CANid of the spark max
	 * @param type
	 *            Type of motor connected to the speed controler
	 * @param ctl
	 *            The control mode to be used when set is called.
	 */
	 ...
	 *
	 * @param speed
	 *            the percent utilization to run the motor at.
	 */

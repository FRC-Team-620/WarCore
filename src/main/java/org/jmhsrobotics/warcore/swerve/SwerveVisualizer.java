...
public class SwerveVisualizer {
	...
	/**
	 * @param robotWidthMeters
	 *            distance between left and right swerve modules
	 * @param robotLengthMeters
	 *            distance between front and back swerve modules
	 */
	public SwerveVisualizer(double robotWidthMeters, double robotLengthMeters) {
		...
		this.update(new Rotation2d(), new Rotation2d(), new Rotation2d(), new Rotation2d(), new Pose2d()); // Start
		// Visualization
		// at 0,0
		// with Zero
		// wheel
	 ...
	 * of the wheels about the robot center.
	 *
	 * @param flWheelRot
	 *            The rotation of the front left wheel
	 * @param frWheelRot
	 *            The rotation of the front right wheel
	 * @param blWheelRot
	 *            The rotation of the back left wheel
	 * @param brWheelRot
	 *            The rotation of the back right wheel
	 * @param rBase
	 *            The Pose2d object representing the robot base, i.e. the chasse
	 */
	 ...
	 *
	 * @param relativePos
	 *            The position of the Pose2d to be rotated relative to the Pose2d
	 *            origin
	 * @param rotateOrigin
	 *            The Pose2d storing the origin
	 * @param rotateAngle
